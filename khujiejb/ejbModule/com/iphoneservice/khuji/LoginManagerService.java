...
public class LoginManagerService {
	...
	public String login(KhujiUser user) {
	...
	public boolean userExists(KhujiUser user) {
		...
		Session hbsession = ((org.hibernate.ejb.EntityManagerImpl) em
				.getDelegate()).getSession();
		List<KhujiUser> userFromDBList = hbsession
				.createCriteria(KhujiUser.class)
				.add(Property.forName("username").eq(
						user.getUsername())).list();
		KhujiUser userFromDB=userFromDBList.get(0);
		if (userFromDB == null) {
			return false;
		}
		return true;
	...
	public String checkPassword(KhujiUser user) {
//TODO:Z
		Session hbsession = ((org.hibernate.ejb.EntityManagerImpl) em
				.getDelegate()).getSession();
		List<KhujiUser> userFromDBList = hbsession
	...
	public String sendForgottenPassword(KhujiUser user) {
		Session hbsession = ((org.hibernate.ejb.EntityManagerImpl) em
				.getDelegate()).getSession();
		List<KhujiUser> userFromDBList = hbsession
				.createCriteria(KhujiUser.class)
		...
		// Recipient's email ID needs to be mentioned.
	      ...
	      javax.mail.Session session = javax.mail.Session.getInstance(props,
		      ...
		      return new PasswordAuthentication("khuji@gmail.com","rejowana");
		      }
		      });
	      ...
	      try{
	         ...
	         message.setSubject("Khuji - Your password");
