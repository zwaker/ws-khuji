...
import com.iphoneservice.khuji.LoginManagerService;
import com.iphoneservice.khuji.RegistrationManagerService;
import com.iphoneservice.khuji.UserManagerService;
...
public class UserManager implements Serializable {
	...
	public String respondToRequest() {
		...
		mapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES,
				false);
		KhujiUser user = new KhujiUser();
		
		String returnString = "";
		try {
			JSONObject jsonObj = requestParamsToJSON(httpServletRequest);

			user = mapper.readValue(jsonObj.toString(), KhujiUser.class);
		...
		if (type.equals("registration")) {
			returnString = registrationMangerService.registerUser(user);
